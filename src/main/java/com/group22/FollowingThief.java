...
public class FollowingThief extends LandMover {
    ...
    /**
     * Method to check for the next tile to move to, 
     * if the last move direction was to the right.
     */
    public void ifRight() {
    ...
    /**
     * A method to check for the next tile to move to, 
     * if the last move direction was to the left.
     */
    public void ifLeft() {
    ...
    /**
     * A method to check for the next tile to move to, 
     * if the last move direction was upwards.
     */
    public void ifUp() {
