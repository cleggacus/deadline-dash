...
public class Sprite {
    ...
    // public void layerImageSet(String set1, String set2, String outputSet) {
    //     Image[] setImages1 = this.images.get(set1);
    //     Image[] setImages2 = this.images.get(set2);

    //     double length = Math.max(setImages1.length, setImages2.length);

    //     double image1Increment = length / (double)setImages1.length;
    //     double image2Increment = length / (double)setImages2.length;

    //     Image[] outputImages = new Image[length];

    //     for(int i = 0; i < length; i++) {
    //         int i1 = (int)Math.floor(i / image1Increment);
    //         int i2 = (int)Math.floor(i / image2Increment);

    //         Image image1 = setImages1[i1];
    //         Image image2 = setImages2[i2];

    //         outputImages[i] = compositeImage(image1, image2);
    //     }
    // }

    // public static Image compositeImage(Image image1, Image image2) {
    ...
    //             // a0 = aa + ab(1-aa)
    //             // c0 = (c2*a2 + c1*a1(1-a2))/a0

    //             double alpha = alpha2 + alpha1 * (1 - alpha2);

    //             double red = (
    //                 color2.getRed() * alpha2 + 
    //                 color1.getRed() * alpha1 * (1 - alpha2)
    //             ) / alpha;

    //             double green = (
    //                 color2.getGreen() * alpha2 + 
    //                 color1.getGreen() * alpha1 * (1 - alpha2)
    //             ) / alpha;

    //             double blue = (
    //                 color2.getBlue() * alpha2 + 
    //                 color1.getBlue() * alpha1 * (1 - alpha2)
    //             ) / alpha;
